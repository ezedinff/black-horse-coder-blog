...
const Hero = () => {
  return (
    <>
      <section className="profile-container pt-12 text-center">
        <div className="mx-auto  flex flex-wrap flex-col md:flex-row">
          <div className="w-full hidden md:block md:w-2/5 text-center">
            <img
              className="w-full md:w-4/5 z-50 relative -mt-20"
              src="images/ez.png"
              loading="lazy"
              alt="Ezedin Fedlu picture"
            />
          </div>
          <div className="flex flex-col w-full md:w-3/5 justify-center items-start text-center md:text-left">
            <p className="uppercase tracking-loose w-full">Hello, I'm</p>
            <h1 className="bottom-border my-4 text-5xl mx-auto sm:mx-0 font-bold leading-tight">
              Ezedin Fedlu .
            </h1>
            <p className="leading-normal bg-gray-900 z-50 text-2xl mb-8">
            I'm a software engineer based in Addis Ababa, specializing in building (and occasionally designing) exceptional websites, applications, and everything in between.
            </p>
            <ul className="flex justify-self-start sm:justify-self-center max-w-md mx-auto sm:mx-0">
                  <li className="mx-2">
                    <a
                      className="social"
                      href="https://github.com/ezedinff"
                      aria-label="GitHub"
                    >
                      <svg
        ...
        <div className="relative mt-5 lg:-mt-24">
          <svg
